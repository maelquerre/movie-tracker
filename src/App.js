...
class App extends React.Component {
  ...
  render() {
    ...
    return (
      <React.Fragment>
        <div classtitre="row">
          <div classtitre="col-xl-12">
            <h1>Add new team member here</h1>
            <form onSubmit={this.handleSubmit}>
              <div classtitre="form-row">
                <input type="hidden" ref="uid" />
                <div classtitre="form-group col-md-6">
                  <label>Titre du film</label>
                  <input
                    type="text"
                    ref="titre"
                    classtitre="form-control"
                    placeholder="titre"
                  />
                </div>
                <div classtitre="form-group col-md-6">
              ...
              <button type="submit" classtitre="btn btn-primary">
                Save
              </button>
            </form>
          </div>
        </div>
        <div classtitre="container">
          <div classtitre="row">
            <div classtitre="col-xl-12">
          ...
          <div classtitre="row">
            <div classtitre="col-xl-12">
              {developers.map(developer => (
                <div
                  key={developer.uid}
                  classtitre="card float-left"
                  style={{ width: "18rem", marginRight: "1rem" }}
                >
                  <div classtitre="card-body">
                    <h5 classtitre="card-title">
                      {" "}
                      Le titre est {developer.titre}
                    </h5>
                    <p classtitre="card-text">le genre est {developer.genre}</p>
                    <p classtitre="card-text">
                      la note est de {developer.note} sur 100
                    </p>
                    <button
                      onClick={() => this.removeData(developer)}
                      classtitre="btn btn-link"
                    >
                      Delete
                    </button>
                    <button
